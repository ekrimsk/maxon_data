...
string_start = "curl 'https://www.maxongroup.us/maxon/view/category/prodfilter/motor?pn_id=ProductSearch&pn_p=";
string_end = "&pn_ok=&_=1562787797405' -H 'Cookie: isSdEnabled=false; JSESSIONID=E2219EC5F650E53E508301B2284A6430.node1; TS01c7a627=01f8768e723de6f22829497168da1bcd11bad1ca856a5e1c7947c9d4c854cf03ee01b6bc6063ce67af831203014db13b93de2ecc83e1a2fcab73454642e14f19cdaac9d9af; atuserid=%7B%22name%22%3A%22atuserid%22%2C%22val%22%3A%22813fce16-d4b4-4387-95e1-cad7ab82e4eb%22%2C%22options%22%3A%7B%22end%22%3A%222020-08-02T15%3A59%3A00.097Z%22%2C%22path%22%3A%22%2F%22%7D%7D; _ga=GA1.2.1077307880.1562083140; _et_coid=6a2dfd84c83ed8b4a390b2f620dcff9f; BT_pdc=eyJ2aWQiOiJOQSIsImV0Y2NfY3VzdCI6MCwiZWNfb3JkZXIiOjAsImV0Y2NfbmV3c2xldHRlciI6MCwic21zIjpudWxsLCJub19zaWduYWxpemUiOmZhbHNlfQ%3D%3D; _gid=GA1.2.1044723703.1562693225; TS01780029=01f8768e721a5f4d74077239ead5cce01378b32ce86a5e1c7947c9d4c854cf03ee01b6bc606f931ea3b2210183c102de6df69f39bb; BT_ctst=101; BT_sdc=eyJldF9jb2lkIjoiTkEiLCJyZnIiOiIiLCJ0aW1lIjoxNTYyNzg3NzcyMjQ2LCJwaSI6MCwiZXVybCI6Imh0dHBzOi8vd3d3Lm1heG9uZ3JvdXAudXMvbWF4b24vdmlldy9jb250ZW50L2luZGV4IiwicmV0dXJuaW5nIjowLCJldGNjX2NtcCI6Ik5BIiwic21zIjpudWxsLCJub1dTIjoibTlnYXhLIn0%3D; _gat_UA-59797293-7=1; _gat_UA-59797293-1=1' -H 'Accept-Encoding: gzip, deflate, br' -H 'Accept-Language: en-US,en;q=0.9,he-IL;q=0.8,he;q=0.7,es-US;q=0.6,es;q=0.5' -H 'User-Agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36' -H 'Accept: */*' -H 'Referer: https://www.maxongroup.us/maxon/view/category/motor?etcc_cu=onsite&etcc_med_onsite=Product&etcc_cmp_onsite=DCX+Program&etcc_plc=Overview-Page-DC-Motors&etcc_var=%5bus%5d%23en%23_d_&target=filter&filterCategory=DCX' -H 'X-Requested-With: XMLHttpRequest' -H 'Connection: keep-alive' --compressed > tmp_motor.html"


idx = 1; 


for i = 1:65 % 63 for usa, 65 for switzerland idk why  
    ...
    for k = 3:length(data_split)
        ...
        if  isempty( strfind(description, 'compact drive'))  % skip these 
            ...
            while isempty( strfind(ms_string, 'Max. speed'))
                j = j + 1; 
                ms_string = spec_split{24 + j};
            end 
